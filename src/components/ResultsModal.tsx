  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      <div
        ...
        onClick={onClose}
      ></div>
      <div className="bg-primary-800 p-4 rounded-lg shadow-lg z-10 w-1/4 h-1/4">
        <div className="h-full w-full flex flex-col justify-between text-center text-primary-200 text-xl">
          <div
            id="result"
            className="rounded-lg bg-white p-2 md:p-6 md:shadow"
          >
